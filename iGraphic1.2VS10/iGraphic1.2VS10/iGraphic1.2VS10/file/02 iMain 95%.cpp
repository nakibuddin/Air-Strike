...
struct bubble
{
	...
	int dx;
	int dy;
}	bubble[20]={{(255+rand() % 810),712,-3,-3},{(255+rand() % 810),712,3,-4},{(255+rand() % 810),1050,4,-3},
						{(255+rand() % 810),1550,-4,-4},{(255+rand() % 810),1800,-2,-5}};
...
void common_variable_reinitialization()
{
	...
	bubble[0].bubbleX = (255+rand() % 810);
	bubble[0].bubbleY = 712;
	bubble[1].bubbleX = (255+rand() % 810);
	bubble[1].bubbleY = 712;
	bubble[2].bubbleX = (255+rand() % 810);
	bubble[2].bubbleY = 1050;
	bubble[3].bubbleX = (255+rand() % 810);
	bubble[3].bubbleY = 1550;
	bubble[4].bubbleX = (255+rand() % 810);
...
{	
	...
	iSetTimer(500000,dummy);		// timer number 1, previously it was for bullte_change_and_collision something like that
